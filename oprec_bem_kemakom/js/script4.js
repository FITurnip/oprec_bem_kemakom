                ...
                success: function (response) {
                    if (response != null) {
                        ...
                        if (response.Kelolosan == 1) {
                            // Pesan Diterima
                            $(".modal-header").html(`
                                <h4 class="mx-auto"> Selamat <strong>` + response.Nama + `</strong>!<br/> Kamu <Strong>diterima</strong> sebagai <strong>anggota BEM KEMAKOM 2024-2025</strong></h4>
                            `);
                            $(".animasi").html(`
                                <img src="assets/selamat.gif" height="400" alt="">
                            `);
                            // Konidisi status jika calon gagal
                        } else {
                            // Pesan Gagal
                            $(".modal-header").html(`
                                <h4 class="mx-auto">Maaf <strong>` + response.Nama + `</strong>!<br/> Kamu <strong>belum beruntung</strong> menjadi bagian dari kami!😓</h4>
                            `);
                            $(".animasi").html(`
                                <img src="assets/tetap-semangat.gif" height="400" alt="">
                        `);
                        }
